...
import static main.java.ua.cv.travian.entity.Specialty.Defense;
import static main.java.ua.cv.travian.entity.Specialty.Machinery;
import static main.java.ua.cv.travian.entity.Specialty.Offense;
import static main.java.ua.cv.travian.entity.Specialty.Scouting;
...
public enum UnitType {
	...
	private UnitType(Race race, String name, Integer atack, Integer infantryDef, Integer cavalryDef, Integer upkeep, Integer speed,
	...
	public String htmlClasses() {
		return StringUtils.join(specialties, " ");
	}
