System.register(["@angular/core", "@angular/platform-browser", "@angular/http", "@angular/forms", "./app.component", "./alliance/alliance.component", "./header/header.component", "./services/alliance-service", "./alliance/addalliance.component", "./alliance/editalliance.component", "./modal_window/modal", "@angular/router", "./player/player.component", "./player/playerList.component", "./player/playerRow.component", "./player/playerHeader.component", "./services/player.service", "./village/editViallage.component", "./services/newVillageArmiesService", "./village/editVillageForm.component", "./army/armyCellComponent", "./village/villageRow.component", "./services/villageService", "./village/addVillageForm"], function (exports_1, context_1) {
    "use strict";
