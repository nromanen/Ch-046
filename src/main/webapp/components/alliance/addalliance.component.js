        ...
        execute: function() {
            AllianceForm = (function () {
                ...
                AllianceForm = __decorate([
                    ...
                    __metadata('design:paramtypes', [forms_1.FormBuilder, (typeof (_a = typeof alliance_service_1.AllianceService !== 'undefined' && alliance_service_1.AllianceService) === 'function' && _a) || Object])
                ], AllianceForm);
                return AllianceForm;
                var _a;
            }());
