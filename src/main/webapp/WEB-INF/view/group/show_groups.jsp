...
<head>
    ...
    <link href="/resources/css/groups.css" rel="stylesheet">
                ...
                <tr>
                    ...
                    <th class="vertical-text-center text-center">
                        <form method="get" action="/groups/update">
                            <button class="btn btn-primary btn-update" type="submit" name="group_id" value="${group.id}">Update</button>
                        </form>
                        <form method="post" action="/groups/delete" class="last-form">
                            <button class="btn btn-danger" type="submit" name="group_id" value="${group.id}">Delete</button>
                        </form>
                    </th>
                </tr>
            </c:forEach>
